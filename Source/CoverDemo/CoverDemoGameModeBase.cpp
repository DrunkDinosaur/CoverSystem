...
void ACoverDemoGameModeBase::PostActorCreated()
{
	...
	// that and creating a custom nav agent under project settings -> navigation system -> agents -> supported agents,
	// whose navigation data class and preferred nav data should be set to our class.
